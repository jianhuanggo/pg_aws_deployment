...
def example_command_center_ec2():
    """
    ...
    project_name = "pg_command_center"
...
def example_command_center_ec2_destroy():
    """this function is used to destroy the resources created by example_command_center_ec2
