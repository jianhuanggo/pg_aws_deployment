...
def example_website_ec2_react(
    ...
    build_image.run(ecr_repository_name=ecr_repository_name,
                    ...
                    dockerfile_filepath=f"{project_path}/Dockfile_react"
                    )
    ...
    #                 aws_account_number,
    #                 project_path,
    #                 "/Users/jianhuang/projects/ui/pg_website_react2/Dockfile_react"
    #                 )
...
def example_website_ec2_react_destroy(
        project_name: str = "pg_simple_website_react",
        project_path: str = "/Users/jianhuang/projects/ui/pg_website_react2"):
    """this function is used to destroy the resources created by example_website_ec2_react
